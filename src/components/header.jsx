...
const products = [
  ...
  { name: 'Components', description: 'A brief overview of what the component is', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Prices', description: 'See our pricing plans or product prices', href: '#Prices', icon: CurrencyDollarIcon},
]
